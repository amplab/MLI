...
// */
//case class MultiModelStochasticGradientDescentParameters(
//                                                params: Seq[StochasticGradientDescentParameters]
//                                                ) extends MLOptParameters
//
//
//object MultiModelStochasticGradientDescent extends MLOpt with Serializable {
//  /**
...
//   * @return
//   */
//  def apply(data: MLTable, params: MultiModelStochasticGradientDescentParameters): MLTable = {
...
//              ): MLRow = {
//
//    //First let's construct the thing that takes a row and produces a collection of rows.
//    //val multiFun = x:Int => 2
//
...
//   */
//  def localSGD(data: MLMatrix, weights: Seq[MLVector], lambda: Double, gradientFunction: Seq[(MLRow, MLRow) => MLRow]): MLMatrix = {
//    //Set local weights.
//    var loc = weights
//
